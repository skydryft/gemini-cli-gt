...
import { spawnAsync as mockSpawnAsync } from '@skydryft/gemini-cli-core';

// Mock @skydryft/gemini-cli-core
vi.mock('@skydryft/gemini-cli-core', async () => {
  const original = await vi.importActual<
    typeof import('@skydryft/gemini-cli-core')
