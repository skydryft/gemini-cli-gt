# Gemini CLI Test Utils (`@skydryft/gemini-cli-test-utils`)
...
1. **Programmatic Builder:**
   ...
   ```typescript
   import { TestMcpServerBuilder } from '@skydryft/gemini-cli-test-utils';
...
Import from `@skydryft/gemini-cli-test-utils` in test files across the monorepo.
